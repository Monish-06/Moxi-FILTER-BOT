...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ', url=f'https://t.me/{SUPPORT_CHAT}'),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                InlineKeyboardButton('⤬ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ⤬', url=f'http://t.me/ɪɪᴛsᴍᴇ𝟸𝟾𝟶𝟽')
            ],[
                InlineKeyboardButton('ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url=CHNL_LNK),
                InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url=GRP_LNK)
            ],[
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        await sts.delete()
        k = await client.send_message(chat_id = message.from_user.id, text=f"<ʙʟᴏᴄᴋǫᴜᴏᴛᴇ><ʙ><ᴜ>❗️❗️❗️ɪᴍᴘᴏʀᴛᴀɴᴛ❗️️❗️❗️</ᴜ></ʙ>\ɴ\ɴᴛʜᴇsᴇ ᴄʟɪᴘs ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ɪɴ <ʙ><ᴜ>2 ʜᴏᴜʀs</ᴜ> 🫥 <ɪ></ʙ>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs)</ɪ>.\ɴ\ɴ<ʙ><ɪ>ᴘʟᴇᴀsᴇ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ʙᴇғᴏʀᴇ ɪᴛ ɢᴇᴛs ᴅᴇʟᴇᴛᴇᴅ 🤕</ɪ></ʙ></ʙʟᴏᴄᴋǫᴜᴏᴛᴇ>")
    ...
    if not files_:
        ...
        try:
            ...
            btn = [[InlineKeyboardButton("🔁 Request File Again 🔁", url=f"https://t.me/moxi_movies_grp")]]
